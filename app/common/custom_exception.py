...
class CustomException(Exception):
    ...
    def get_detailed_error_message(message, error_detail):
        _, _, exc_tb = sys.exc_info() #if exception, it will retrun like (<class 'ZeroDivisionError'>, ZeroDivisionError('division by zero'), <traceback object at 0x0000021E950C9300>)
